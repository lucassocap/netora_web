...
import RequestAutopartModal from '../components/RequestAutopartModal';
...
const { isOpen: openMenu4, toggleDropdown: handleBtnClick4, closeDropdown: closeMenu4, ref: ref4 } = useDropdown();
  ...
  const [showAutopartModal, setShowAutopartModal] = useState(false);
        ...
        <div className="container">
          ...
          <div className="menu_side_area" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <button
                ...
                onClick={() => setShowAutopartModal(true)}
              >
                {t('menu.requestAutopart')}
              </button>
              {/* Language Switcher */}
              <div style={{ display: 'flex', gap: '4px' }}>
                <button
                className="btn-line"
                  style={{ padding: '6px 14px', fontWeight: 'bold', border: i18n.language === 'en' ? '2px solid #007bff' : '2px solid transparent' }}
                ...
                <button
                className="btn-line"
                  style={{ padding: '6px 14px', fontWeight: 'bold', border: i18n.language === 'es' ? '2px solid #007bff' : '2px solid transparent' }}
              ...
              {/********* Burger Button *********/}
              <RequestAutopartModal open={showAutopartModal} onClose={() => setShowAutopartModal(false)} />
          </div>
          {/********* Side Button *********/}
